...
var MyGame_stringOfPlayer = Connect4$GameProject.Connect4.stringOfPlayer;

var MyGame_stringOfState = Connect4$GameProject.Connect4.stringOfState;

var MyGame_stringOfMove = Connect4$GameProject.Connect4.stringOfMove;

var MyGame_initialState = Connect4$GameProject.Connect4.initialState;

var MyGame_legalMoves = Connect4$GameProject.Connect4.legalMoves;

var MyGame_currentPlayer = Connect4$GameProject.Connect4.currentPlayer;

var MyGame_gameStatus = Connect4$GameProject.Connect4.gameStatus;

var MyGame_nextState = Connect4$GameProject.Connect4.nextState;

var MyGame_moveOfString = Connect4$GameProject.Connect4.moveOfString;

var MyGame_estimateValue = Connect4$GameProject.Connect4.estimateValue;
...
var MyGame = {
  ...
  currentPlayer: MyGame_currentPlayer,
...
function nextMove(s) {
  while(true) {
    ...
    try {
      return Curry._2(Connect4$GameProject.Connect4.moveOfString, input, s);
    }
    catch (raw_msg){
      var msg = Caml_js_exceptions.internalToOCamlException(raw_msg);
      if (msg.RE_EXN_ID !== "Failure") {
